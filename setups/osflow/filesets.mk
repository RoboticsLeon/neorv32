...
RTL_PHERIPH_SRC := $(RTL_CORE_SRC)/wishbone_pheripheral
RTL_MODULES_SRC := $(RTL_CORE_SRC)/modules
RTL_WISHBONE_INTERCON_SRC := $(RLT_CORE_SRC)/wishbone_interconnect
...
NEORV32_CORE_SRC := \
  ...
  NEORV32_PERIPH_SRC := \
  $(RTL_PHERIPH_SRC)/wb_regs.vhd \
  $(RTL_PHERIPH_SRC)/driver_teclado.vhd \
  ...
  $(RTL_WISHBONE_INTERCON_SRC)/wb_arbiter.vhd \
  $(RTL_WISHBONE_INTERCON_SRC)/wb_master_mux.vhd \
  $(RTL_WISHBONE_INTERCON_SRC)/wb_slave_sel.vhd \
  $(RTL_WISHBONE_INTERCON_SRC)/wb_slave_mux.vhd
